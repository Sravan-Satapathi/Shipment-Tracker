          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`input-field pl-10 ${errors.shipmentTitle ? 'border-red-500' : ''}`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={formData.cost}
                  onChange={handleChange}
                  className={`input-field pl-10 ${errors.cost ? 'border-red-500' : ''}`}
                  placeholder="0.00"
                  step="0.01"
                  min="0"
                  disabled={loading}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`input-field pl-10 ${errors.shipmentDate ? 'border-red-500' : ''}`}
                  disabled={loading}
                />
              </div>
              {errors.shipmentDate && (
