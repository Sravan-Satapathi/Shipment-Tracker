    ...
    return (
        <div className="d-flex align-items-center justify-content-center vh-100 position-relative"
            ...
            <Link to="/" className="position-absolute top-0 start-0 p-4 d-flex align-items-center gap-2 text-decoration-none">
                ...
                <span className="fs-4 fw-semibold text-light">ShipEngine</span>
            </Link>
            ...
            {!isEmailSent && (
                <div className="rounded-4 p-5 text-center bg-white" style={{width:'100%', maxWidth:'400px'}}>
                    ...
                    <p className="mb-4">Enter the registered email address</p>
                    ...
                    <form onSubmit={onSubmitEmail}>
                        ...
                        <button className="btn btn-outline-custom w-100 py-2" type="submit" disabled={loading}>
            ...
            {!isOtpSubmitted && isEmailSent && (
                <div className="p-5 rounded-4 shadow bg-white" style={{width:"400px"}}>
                    ...
                    <button className="btn btn-outline-custom w-100 fw-semibold" disabled={loading} onClick={handleVerify}>
            ...
            {/*New password Form*/}
            {isOtpSubmitted && isEmailSent && (
                <div className="p-4 rounded-4 text-center bg-white" style={{width:"100%",maxWidth:"400px"}}>
                    <h4>New password</h4>
                    ...
                    <form onSubmit={onSubmitNewPassword}>
                        ...
                        <button type="submit" className="btn btn-outline-custom w-100" disabled={loading}>
                            {loading ? "Loading..." : "Submit"}
                        </button>
                    </form>
                </div>
